...
cp -r ${PATH_COS}/s3_${COS_BUCKET_PRIVATE}/prow-docker/build-docker-v27.1.0_260724-0610/containerd-${CONTAINERD_TAG}/* /workspace/containerd-${CONTAINERD_TAG}_${DATE}
cp -r ${PATH_COS}/s3_${COS_BUCKET_PRIVATE}/prow-docker/build-docker-v27.1.0_260724-0610/containerd-${CONTAINERD_TAG}/* /workspace/containerd-${CONTAINERD_TAG}
